...
import { Home, Users, Building, BarChart3, Menu, Settings, X, ClipboardList, LogOut, Shield, Zap, Clock, Download, Calculator } from 'lucide-react';
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center w-full px-4 py-3 rounded-lg transition-all duration-200 group ${isActive
                ...
                >
                  ...
                  {item.label}
                  {item.badge && (
                    <span className={`ml-auto px-2 py-0.5 text-xs font-bold rounded-full ${isActive
          ...
          <div className="p-4 border-t border-white/10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${canViewTeam
